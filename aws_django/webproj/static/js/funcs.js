...
// var res_size = ParseInt({{ res_list|length }});
// var res_size = 2
// var count = 0;
// window.onscroll = function() {
//     if((window.innerHeight + window.scrollY) >= document.body.offsetHeight && count < res_size) {
//         count++;
//         var wraps = document.getElementsByClassName('wraps');
//         var li_list = createForm()
      
//         wraps.append(li_list)
